...
export const Footer = () => {
  return (
    <footer className="bg-gray-50 px-4 md:px-8 py-10 mt-10 dark:text-white dark:bg-gray-800">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center py-4 gap-6">
          <div className="flex flex-wrap gap-4 items-center justify-center">
            <p className="font-medium text-gray-700  dark:text-white">Payment Partners</p>
